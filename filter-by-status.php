...
<head>
    ...
    <title>Birhan Solutions|Admin Page|Filter by status</title>
    <style type="text/css">
        .wrapper {
            width: 500px;
            margin: 0 auto;
...
<body style="margin-left: 30px;margin-right:30px">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Filter Based On Status</h2>
                    </div>


                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;">
                            <input type="text" class="form-control" name="filt_stat" placeholder="Enter The Status To Search*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
    ...
    if (isset($_POST['submit'])) {
        $status = $_POST["filt_stat"];
        $sql = "SELECT * FROM Developers_info where emp_status='$status'";
